...
public class TweaksGui extends AbstractGui {
    ...
    protected void actionPerformed(GuiButton button) {
        switch (button.id) {
            ...
            case 12:
                Settings.RAYTRACEBLOCKS = !Settings.RAYTRACEBLOCKS;
                button.displayString = getSuffix(Settings.RAYTRACEBLOCKS, "Raytrace Blocks");
                break;
        }
    }
    ...
    protected String getButtonTooltip(int buttonId) {
        switch (buttonId) {
            ...
            case 12:
                return "Ignore plants when toggling perspective, allowing you to view normally (like 1.14) when moving through plants.";
